    ...
    <div className='bg-[rgb(5,8,19)] '>
      ...
      {open && (
        <ul className="md:hidden flex flex-col font-medium gap-4 mt-4 bg-zinc-900 p-4 rounded text-white">
          ...
          <div className='flex gap-2'>
            <a href="https://www.instagram.com/aman_yadav0512?igsh=ZmJsM3h0Z2p3bGF2" target="_blank">
          ...
          <div className='flex gap-2'>
            <a href="https://www.linkedin.com/in/aman-yadav-9a8471299"><svg xmlns="http://www.w3.org/2000/           svg" viewBox="02424" fill="currentColor" class="w-6 h-6 text-blue-700"><path d="M4.98 3.5C4.98 4.88 3.87 6 2.49 6S0 4.88  0 3.5 1.11 1 2.49 1s2.49 1.12 2.49 2.5zM.5 8h4v14h-4V8zm7 0h3.6v1.92h.05c.5-.95 1.72-1.95 3.54-1.95 3.78 0 4.48 2.49 4.48 5.73V22h-4v-7.5c0-1.79-.03-4.1-2.5-4.1-2.5 0-2.88 1.95-2.88 3.97V22h-4V8z" /></svg>
            </a>
            <p>linkedin</p>
          </div>

          <div className='flex gap-2'>
            <a href="https://github.com/amanydv051204-hub/"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24       24" fill="currentColor" class="w-6 h-6 text-white"><path fill-rule="evenodd" clip-rule="evenodd"
      ...
      <div className='hidden md:flex bg-[rgb(5,8,19)] pl-10 items-center h-15 justify-between w-35rem md:w-48rem lg:w-64rem'>
        ...
        <div className='flex gap-10 pr-10'>
          ...
          <a href="https://www.linkedin.com/in/aman-yadav-9a8471299"></a>

          <a href="https://github.com/amanydv051204-hub/"></a>
        </div>
      </div>
    </div>
  )
