    ...
    <div>
        ...
        <div className='flex flex-col gap-5 order-2 lg:order-1 lg:p-0 pl-10'>
          ...
          <div className='flex gap-5'>
            <a
              ...
              className="flex justify-center items-center w-20 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition duration-300"
            >
              Hire Me
            </a>
          ...
          <div className="flex gap-4 mt-5">
            <a
              href="https://github.com/amanydv051204-hub/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.instagram.com/aman_yadav0512?igsh=ZmJsM3h0Z2p3bGF2"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/aman-yadav-9a8471299"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <div className='bg-[rgb(240,241,243)] h-100'>
        <div className='pl-5 lg:pr-40 lg:pl-40 lg:pt-20 pt-5 lg:gap-5 flex flex-col'>
          <h1 className='font-bold text-[25px] lg:text-5xl bg-gradient-to-r from-blue-500 to-black bg-clip-text text-transparent'>
            About Me
          </h1>

          <p className='font-semibold text-md lg:text-2xl'>
            I’m tech professional and love building things that make a difference.
            Technology excites me, and I enjoy tackling challenges with creative solutions.
            I’m curious by nature, always learning, and thrive when bringing fresh ideas to projects.
            My goal is to grow, contribute meaningfully, and make every project I touch better than before.
          </p>
